...
|CSC V3|Capship Command script with AXUI|21.0|AxBase|TheForce172|
...
|Plasma Core|A framework to support script module development, including live reloads and semi-interactive workflow.|23.0|RequireVersion 1.0, (Optional) Fennel 1.3.0 |EatThePath|
...
|RequireVersion|Provides tools for dependancy script version checking based on semver| | |EatThePath|
|SaveLoad|A full-featured savestate system|23.0||Admiral MS, Goober5000|
